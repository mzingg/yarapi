...
class Log_observer {
    ...
    *           The highest priority at which to receive
    ...
    *
    * @param string $type
    *           The type of concreate Log_observer subclass
    *           to return.
    * @param integer $priority
    *           The highest priority at which to receive
    *           log event notifications.
    * @param array $conf
    *           Optional associative array of additional
   ...
   function &factory($type, $priority = PEAR_LOG_INFO, $conf = array()) {
      ...
      /*
       * If the desired class already exists (because the caller has supplied it from some custom location), simply instantiate and return a new instance.
       */
    ...
    * something when they are notified of a message.
