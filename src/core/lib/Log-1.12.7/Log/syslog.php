...
class Log_syslog extends Log {
   ...
   /**
    * Maximum message length that will be sent to syslog().
    * If the handler
    ...
    * @param int $priority
    *           (optional) The priority of the message. Valid
   ...
   function log($message, $priority = null) {
      ...
      $message = $this->_format($this->_lineFormat, strftime($this->_timeFormat), $priority, $message);
    ...
    *
    * @param int $priority
    *           PEAR_LOG_* value to convert to LOG_* value.
    *           
