 ...
 * This is generally defined in the DB.php file,
 ...
 * abstract class which sends messages to an SQL server.
 * Each entry
...
class Log_sql extends Log {
   ...
   /**
    * Maximum length of the $ident string.
    * This corresponds to the size of
    ...
    * It is the caller's responsible to close an
