...
class Log_display extends Log {
    ...
    * the log system.
    * Otherwise, the text will be converted to an HTML-safe
    * representation.
    *
    * @var boolean
    * @access private
   ...
   function log($message, $priority = null) {
      ...
      /*
       * Convert the message to an HTML-friendly represention unless raw text has been requested.
       */
      ...
      echo $this->_format($this->_lineFormat, strftime($this->_timeFormat), $priority, $message);
