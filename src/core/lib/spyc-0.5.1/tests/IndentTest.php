...
class IndentTest extends PHPUnit_Framework_TestCase {
   ...
   public function testIndent_5() {
      $this->assertEquals(array(array('row' => 0, 'col' => 0, 'headsets_affected' => array(array('ports' => array(0), 'side' => 'left')), 'switch_function' => array('ics_ptt' => true))), $this->Y['nested_hashes_and_seqs']);
   }
