...
class OutputFormatter implements OutputFormatterInterface {
    ...
    * @param array $styles
    *           Array of "name => FormatterStyle" instance
    *           
    *           @api
    */
    ...
    *
    * @param Boolean $decorated
    *           Whether to decorated the messages or not
    *           
    *           @api
    */
    ...
    * @param string $string           
    *
    * @return Symfony\Component\Console\Format\FormatterStyle Boolean if string is not format string
    */
